...
//$IMConfig['images_dir'] = "demo_images"; //ORIGINAL
...
CN_ClassLoader::getSingleton()->addSearchPath('../../../../../../../cms_classes/');
...
//$GLOBALS["config_all"] = CN_Config::loadFromFile("..".$GLOBALS['project_folder']."/".$_SESSION['user']['name']."/config/config.xml");



/*
session_name("SID_PROJECT");
$session = CN_Session::getSingleton();
$session->start();
*/

//var_dump($_SESSION);
$IMConfig['images_dir'] = "../../../../../../..".$GLOBALS['project_folder']."/".$_SESSION['user']['name']."/mediafiles";
// -------------------------------------------------------------------------
...
//$IMConfig['images_url'] = str_replace( "backend.php", "", $_SERVER["PHP_SELF"] ) . "demo_images"; // ORIGINAL

// nechytat 
// a chytil som. remo
$IMConfig['images_url'] = 'scripts/getImage.php?project='.$_SESSION['user']['name'].'&image=../mediafiles';



//echo "images_dir>".$IMConfig['images_dir'];
//echo "<br>images_url>".$IMConfig['images_url'];
// -------------------------------------------------------------------------
...
$correct_thmb_path = "../../../../../../../../{$_SESSION['user']['name']}"; //str_replace(getcwd().DIRECTORY_SEPARATOR, '', $GLOBALS['cms_root']);

//die($correct_thmb_path);

$IMConfig['thumbnail_dir'] = "_thumbs"; //$IMConfig['images_url']; //'';
