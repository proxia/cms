...
//			var_dump($xml);
	...
	private function cellListAccess(){
		...
		if(get_class($this->current_object) != 'cms_modules\cms_event_calendar\classes\CMS_EventCalendar_Event'){
	...
	private function cellListUnmap_menu(){
		...
		if ( (get_class($this->current_object) == 'CMS_Category') || (get_class($this->current_object) == 'cms_modules\cms_gallery\classes\CMS_Gallery') || (get_class($this->current_object) == 'cms_modules\cms_catalog\classes\CMS_Catalog') || (get_class($this->current_object) == 'cms_modules\cms_event_calendar\classes\CMS_EventCalendar_Event') ){
			if ( ($this->getColumnProperty($cell_name,'onclick') == TRUE) && ($this->getColumnProperty($cell_name,'href')) && ($this->getPrivileges($cell_name) === TRUE) ){
