...
use cms_modules\cms_gallery\classes\CMS_Gallery_Bindings;
		...
		if(!is_null($item_type))
		{
			...
			switch($item_type)
			{
				...
				case 101:
					...
					$list_class_name = 'cms_modules\cms_catalog\classes\CMS_Catalog_ProductList';
				...
				case 104:
					$entity_table_name = 'categories, categories_lang';
					$list_class_name = 'cms_modules\cms_catalog\classes\CMS_Catalog_BranchList';
				...
				case 103:
					$entity_table_name = 'categories, categories_lang';
					$list_class_name = 'cms_modules\cms_catalog\classes\CMS_Catalog_AttributeDefinitionList';
					$display_conditions = array('is_published' => 1, 'is_trash' => 0, '`id` = `categories_lang`.`category_id`' => true, 'language' => "'$language'", 'language_is_visible' => 1);
					$remove_conditions = array('usable_by');
					break;
...
###################################################################################################
	...
	public function delete()
	{
		...
		if(CMS_ProjectConfig::getSingleton()->checkModuleAvailability('cms_modules\cms_gallery\classes\CMS_Gallery') === true)
		{
