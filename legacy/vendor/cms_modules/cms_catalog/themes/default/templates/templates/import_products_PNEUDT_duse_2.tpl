	...
	<tr>
		<td colspan="3">
			<table class="tb_title" cellpadding="0" cellspacing="0">
				<tr>
					<td height="50">&nbsp;&nbsp;{insert name='tr' value='Import produktov - Duše'} 2/2</td>
				</tr>
			</table>
		</td>
	</tr>
			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" border=0 cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_PNEU_duse_2" />
							...
							<td colspan="2" class="td_align_center">
								<table  cellpadding="4" cellspacing="1" border="1" style="margin:10px;border-collapse:collapse;">
									<tr>
										...
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Valve'}</strong></td>
