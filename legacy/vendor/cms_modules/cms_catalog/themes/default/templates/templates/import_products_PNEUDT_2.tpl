			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" border=0 cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_PNEU_2" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								...
								<table  cellpadding="4" cellspacing="1" border="1" style="margin:10px;border-collapse:collapse;">
									<tr>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Výrobca'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Kód produktu'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Rozmer'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='R'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='LI'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='SI'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='XL/RF'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Pattern'}</strong></td>
										...
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Poznámka'}</strong></td>
									</tr>
