...
{/literal}
{assign var='title' value='Skupiny atribútov / prehľad'}
<table class="tb_middle">
	...
	<tr><td colspan="3" class="td_link_v"></td></tr>
		...
		{/php}
	{foreach name='attribut' from=$attribute_group_list item='attribut_id' }
	{/foreach}
		...
		<td class="td_middle_center">
			<table class="tb_list2">
				...
				<tr class="tr_header">
					...
					<td>{insert name='tr' value='Názov skupiny atribútov'}</td>
        	...
        	{if ($user_login_type eq $admin_user)}
       		...
       		{/if}
				...
				<tr id="row{$smarty.foreach.attribut.iteration}" onmouseover="pozadieIN('form1','{$smarty.foreach.attribut.iteration}')" onmouseout="pozadieOUT('form1','{$smarty.foreach.attribut.iteration}')">
					...
					<td>
						{if $showItem eq 1}
							<a href="./?module=CMS_Catalog&mcmd=25&row_id[]={$attribut_id->getId()}">
