		...
		<td colspan="3">
			<table class="tb_title" cellpadding="0" cellspacing="0">
				<tr>
					...
					&nbsp;&nbsp;{insert name='tr' value='Import skladových zásob - Disky'} 1/2
					</td>
				</tr>
			</table>
		</td>
			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_PNEU_disky_1" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								...
								*{insert name='tr' value='Importovaný súbor obsahuje stĺpce : brand; code; mark; model;size; roztec ;ET; price; picture'}


								<p style="text-align:left"><strong>{insert name='tr' value='Príklad obsahu súboru'}</strong></p>

								<table>
								  <tr><td>ALCAR;9160;ALFA;145/146/155 / FIAT Marea/Weekend;6J x 15;4/98,00;49,5;59.9 </td></tr>
								</table>
								</div>
							</td>
						</tr>
