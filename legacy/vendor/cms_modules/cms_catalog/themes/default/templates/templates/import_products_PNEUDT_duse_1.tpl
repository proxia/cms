		...
		<td colspan="3">
			<table class="tb_title" cellpadding="0" cellspacing="0">
				<tr>
					...
					&nbsp;&nbsp;{insert name='tr' value='Import skladových zásob - Duše'} 1/2
					</td>
				</tr>
			</table>
		</td>
			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_PNEU_duse_1" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								...
								*{insert name='tr' value='Importovaný súbor obsahuje stĺpce : brand; code; size; valve; price; picture; notes '}


								<p style="text-align:left"><strong>{insert name='tr' value='Príklad obsahu súboru'}</strong></p>

								<table>
								  <tr><td>KABAT ; DE0001; 7.00-15 ; V3.04.10 ; 10,74 ; /VENTILY/V3_04.jpg ; poznamka</td></tr>
								</table>
								</div>
							</td>
						</tr>
