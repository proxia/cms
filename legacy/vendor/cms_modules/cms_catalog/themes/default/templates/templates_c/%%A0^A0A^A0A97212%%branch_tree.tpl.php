<?php /* Smarty version 2.6.30, created on 2019-05-17 11:22:04
         compiled from branch_tree.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'tr', 'branch_tree.tpl', 94, false),array('insert', 'getOptionListBranch', 'branch_tree.tpl', 191, false),array('insert', 'merge', 'branch_tree.tpl', 215, false),array('insert', 'getNumChild', 'branch_tree.tpl', 314, false),)), $this); ?>
<?php echo '
...
?>
				...
				<?php $this->assign('uroven', $this->_tpl_vars['branch_id']['uroven']); ?>
				<?php $this->assign('space', '-'); ?>
				<?php 
...
')">
					...
					<td><input onclick="setRowBgColor('form1',<?php echo $this->_foreach['branch']['iteration']; ?>
...
" /></td>
					<td><?php echo $this->_tpl_vars['odstup']; ?>
...
"><img src="../themes/default/images/all_m_restore.png" width="16"/></a>
							<?php else: ?>
...
"><img src="../themes/default/images/product_s.gif" /></a> (<?php echo $this->_tpl_vars['numProduct']; ?>
)
							<?php else: ?>
								<img src="../themes/default/images/article_s.gif" /> (<?php echo $this->_tpl_vars['numProduct']; ?>
)
							<?php endif; ?>
						<?php endif; ?>
					</td>
