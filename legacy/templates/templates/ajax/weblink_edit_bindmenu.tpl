{foreach name='menu_list' from=$menu_list_items item='menu_item'}
	...
	<div style="border-bottom:1px solid silver;line-height:25px;">
		<div style="float:left;cursor:pointer;width:25px;height:25px;background-image:url(images/form_delete.gif);background-repeat:no-repeat;background-position:5px center;" onclick="updateAjax('form_bindmenu_list_{$smarty.foreach.menu_list.iteration}','zoznam_bindmenu','goIn','delete')">
		</div>
