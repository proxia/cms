	...
	<tr>
		<td colspan="3">
			<table class="tb_title">
				<tr>
					<td><img class="img_middle" src="images/archive_view.png" alt="" />&nbsp;&nbsp;{insert name='tr' value='Archív článkov'}</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr><td colspan="3" class="td_link_v"></td></tr>
	{foreach name='archive' from=$archive_list item='archive_id' }
	{/foreach}
	{assign var='max_list' value=$smarty.foreach.archive.iteration}
	<tr>
		...
		<td class="td_middle_center">
			...
			{include file="Proxia:default.pager" list=$archive_list}
