...
<table class="tb_middle">
	...
	<tr>
		<td>
			...
			<table class="tb_title">
				<tr>
					<td><img class="img_middle" src="images/cat_view_info.png" alt="" />&nbsp;&nbsp;{insert name='tr' value='Manažér kategórií / Väzby kategórií'}</td>
					<td class="td_align_right">
						...
						<select name="s_category" onchange="form_search.submit()">
							...
							{insert name='getOptionListMappedCategory' free=1 select=$s_category}
						</select>
						&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
  ...
  {assign var='max_list' value=0}	
	{foreach name='category' from=$category_list_filter item='category_id'}
		...
		{if ( ($row_type == 'category') OR ($row_type == 'article') OR ($row_type == 'weblink') )}
