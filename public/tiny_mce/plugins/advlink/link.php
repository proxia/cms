...
try{
	$project_options = CN_Config::loadFromFile($GLOBALS['cms_root']."_sub/".$_SESSION['user']['name'].'/config/config.xml');
...
function zapisLink() {
	...
	if (clanok == 0)
		...
		document.getElementById("title").value = clanokText;
		}
}
...
<body id="advlink" onload="tinyMCEPopup.executeOnLoad('init();');" style="display: none">
  <form name="form_popup" onsubmit="insertAction();return false;" action="#">
		<div class="tabs">
			<ul>
				...
				<fieldset>
					...
					<table border="0" cellpadding="4" cellspacing="0">
						   <tr>
						    ...
						    <td>
								<select name="article" id="article" onchange="zapisLink()">
									...
									<?
										foreach ($article as $article_id){
											...
											//$cn_application
									//	$article_id->setContextLanguage("sk");
									//		echo "<option value=\"".$article_id->getId()."\">".$article_id->getTitle()."</option>";
										}
									?>
								</select>
						...
						<tr>
						  ...
						  <td><table border="0" cellspacing="0" cellpadding="0">
								<tr>
								  ...
								  <td id="">
								  <a href="javascript:insertfile('form_popup','href')" title="{insert name='tr' value='vlož obrázok'}"><img src="../../../../images/paste.gif" width="21" height="21" border="0"></a>
								  &nbsp;</td>
								</tr>
							  </table></td>
						</tr>
