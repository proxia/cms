		...
		switch (type) {
			...
			case "insert_to_editor":
				...
				while ((startPos = content.indexOf('<object', startPos)) != -1) {
					...
					content += ' alt="' + attribs["src"] + '" class="mceItemPROXIAFlash" />' + content.substring(endPos);
			...
			case "get_from_editor":
				...
				while ((startPos = content.indexOf('<img', startPos+1)) != -1) {
					...
					// Insert object + embed
					embedHTML += '<object roman ... vymaz toto classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"';
