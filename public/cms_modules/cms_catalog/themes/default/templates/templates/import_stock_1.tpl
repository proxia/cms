			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_stock_1" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								<table cellpadding="5" cellspacing="1">
									...
									<tr>
										<td>{insert name='tr' value='Stĺpce sú oddelené'}</td>
										<td>
									...
									<tr>
										<td>{insert name='tr' value='Kódovanie súboru'}</td>
										<td>
											<select name="cp_src">
								...
								*{insert name='tr' value='Importovaný súbor obsahuje stĺpce : Kód produktu; počet položiek na sklade'}
								<table>
								  <tr><td>code1;25</td></tr>
								  <tr><td>code2;254</td></tr>
								  <tr><td>code3;0</td></tr>
								</table>
								</div>
							</td>
