		...
		<td colspan="3">
			<table class="tb_title" cellpadding="0" cellspacing="0">
				<tr>
					...
					&nbsp;&nbsp;{insert name='tr' value='Import skladových zásob'} 1/2
					</td>
				</tr>
			</table>
		</td>
			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_PNEU_1" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								...
								<div style="margin:5px;background-color:#e0e0e0;padding:5px 0">
								*{insert name='tr' value='Importovaný súbor obsahuje stĺpce : brand ; code ; size ; R ; LI ; SI ; XL/RF ; pattern ; price ; picture; type '}
								<p style="text-align:left"><strong>{insert name='tr' value='Príklad obsahu súboru'}</strong></p>
								<table>
								  <tr><td>SAVA ; 552573 ; 6,5 ; R16C ; 108 ; L ; ; TAMAR M&S (TL) ; 0,00  ; ; name_of_picture; summer</td></tr>
								  <tr><td>CONTI ; 4750810000 ; 6,5 ; R16C ; 108/107 ; L ; C ; REGIONAL-TRAFFIC LDR ; 0,00; name_of_picture; winter </td></tr>
								  <tr><td>MATADOR ; 4280220000 ; 185 ; R14C ; 102/100 ; R ; ; MPS520 ; 0,00 ; name_of_picture; winter</td></tr>
								</table>
								</div>
							</td>
						</tr>
