			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" border=0 cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_REWAN_2" />
							...
							<td colspan="2" class="td_align_center">
								<table  cellpadding="4" cellspacing="1" border="1" style="margin:10px;border-collapse:collapse;">
									<tr>
										...
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Popis1'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Popis2'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Cena'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Nadradena kategoria'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Obrazok'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Balenie'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Typ vlakna'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Počet vlákien'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Vonkajší plast'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Počet bufferov'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Počet vlákien v bufferi'}</strong></td>
										<td bgcolor="#e0e0e0" style="padding:5px;"><strong>{insert name='tr' value='Typ konštrukcie'}</strong></td>
									</tr>
