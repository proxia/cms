...
{/literal}
{insert name=check}
{assign var='title' value='Produkt / nový'}
	...
	<tr>
		...
		<td class="td_middle_center">
			<table class="tb_list">
				...
				<tr>
					<td>&nbsp;{insert name='tr' value='Zaradenie'}&nbsp;</td>
					<td >
				...
				<tr>
					...
					<td><input type="radio" name="f_isPublished" id="f_isPublished" value="0"  />{insert name='tr' value='Nie'}&nbsp;<input type="radio" name="f_isPublished" id="f_isPublished" value="1" checked="checked"/>{insert name='tr' value='Áno'}</td>
				</tr>
				<tr>
					<td width="40" class="td_valign_top">&nbsp;{insert name='tr' value='Popis'}&nbsp;</td>
