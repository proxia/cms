			...
			<td class="td_valign_top" width="500">
				...
				<tr><td class="td_valign_top" colspan="2">
							...
							<table class="tb_list_in_tab">
								...
								{php}
									$path = "..{$GLOBALS['project_folder']}/".$_SESSION['user']['name']."/mediafiles/".$GLOBALS['smarty']->get_template_vars(detail_product)->getImage();
									$name = basename($path);
							...
							<input type="hidden" id="update_attribut" name="update_attribut" value="1" />
								...
								{php}
									$path = "..{$GLOBALS['project_folder']}/".$_SESSION['user']['name']."/mediafiles/".$GLOBALS['smarty']->get_template_vars(attribut_product_id)->getImage();
									$name = basename($path);
									$GLOBALS["smarty"]->assign("icon_name",$name);
									$GLOBALS["smarty"]->assign("icon_path",$path);
								{/php}
