	...
	<tr>
		<td colspan="3">
			<table class="tb_title" cellpadding="0" cellspacing="0">
				<tr>
					<td height="50">&nbsp;&nbsp;{insert name='tr' value='Import skladových zásob'} 2/2</td>
				</tr>
			</table>
		</td>
	</tr>
			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" border=0 cellpadding="0" cellspacing="0">
						<tr class="tr_header" >
							<td colspan="2">&nbsp;{insert name='tr' value='Odsúhlasenie importu'}</td>
						</tr>
						...
						<input type="hidden" id="section" name="section" value="import_stock_2" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								...
								<table  cellpadding="4" cellspacing="1" border="1" style="margin:10px;">
									<tr>
										...
										<td bgcolor="#e0e0e0" style="padding:5px;">
											<strong>
											{insert name='tr' value='Počet kusov na sklade'}
											</strong>
										</td>
									</tr>
									{foreach from=$import item=row}
										<tr>
												<td style="padding:5px;">{$row.1}</td><td style="padding:5px;">{$row.2}</td>
										</tr>
									{/foreach}
								</table>
							</td>
