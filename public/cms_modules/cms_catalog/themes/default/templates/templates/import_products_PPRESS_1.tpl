			...
			<tr>
				<td class="td_valign_top">
					<table class="tb_list" cellpadding="0" cellspacing="0">
						...
						<input type="hidden" id="section" name="section" value="import_products_PPRESS_1" />
						...
						<tr>
							<td colspan="2" class="td_align_center">
								...
								*{insert name='tr' value='Importovaný súbor obsahuje stĺpce : Kód;Názov;Skupina;hmotnosť v gramoch;množstvo v kartóne;počet kartónov v rade;počet kartónov na palete;EAN kus;EAN box'}
								<p style="text-align:left"><strong>{insert name='tr' value='Príklad obsahu súboru'}</strong></p>
								<table>
								  <tr><td>0300;Bobo gumy;cukríky;80;30;15;150;5 901 660 000 643;5 901 660 001 121</td></tr>
								</table>
								</div>
							</td>
						</tr>
