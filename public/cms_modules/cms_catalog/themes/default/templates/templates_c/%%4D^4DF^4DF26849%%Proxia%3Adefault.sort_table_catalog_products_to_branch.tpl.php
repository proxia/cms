<?php /* Smarty version 2.6.30, created on 2019-05-17 09:50:47
         compiled from Proxia:default.sort_table_catalog_products_to_branch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'tr', 'Proxia:default.sort_table_catalog_products_to_branch.tpl', 15, false),array('insert', 'merge', 'Proxia:default.sort_table_catalog_products_to_branch.tpl', 70, false),)), $this); ?>
...
function sortItems()
{
	...
	var params = "&section=sort_items_product&entity_id="+parent_id+"&entity_type="+parent_type+sort_items;
	params	   += "&goAjax=1";
