<?php /* Smarty version 2.6.30, created on 2019-05-17 10:53:43
         compiled from map_product_atribut.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'tr', 'map_product_atribut.tpl', 76, false),array('insert', 'merge', 'map_product_atribut.tpl', 167, false),array('insert', 'getMapId', 'map_product_atribut.tpl', 186, false),array('insert', 'getAttributValue', 'map_product_atribut.tpl', 208, false),)), $this); ?>
<?php echo '
...
" />
				<input type="hidden" id="section" name="section" value="mapproducttoattribut" />
...
if ($this->_foreach['attribut']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['attribut_id']):
        $this->_foreach['attribut']['iteration']++;
?>
				<input type="hidden" name="map_id[<?php echo $this->_tpl_vars['attribut_id']->getId(); ?>
]" value="<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getMapId', 'productId' => $this->_tpl_vars['detail_product']->getId(), 'attributId' => $this->_tpl_vars['attribut_id']->getId())), $this); ?>
" />
...
<?php endif; ?>
					...
					<td class="td_align_center">
						<input type="text" name="attribut_value[<?php echo $this->_tpl_vars['attribut_id']->getId(); ?>
]" size="30" value="<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getAttributValue', 'productId' => $this->_tpl_vars['detail_product']->getId(), 'attributId' => $this->_tpl_vars['attribut_id']->getId())), $this); ?>
">
					</td>
