{foreach name='category_list' from=$category_list_items item='category_item'}
	...
	<div style="border-bottom:1px solid silver;line-height:25px;">
		<div style="float:left;cursor:pointer;width:25px;height:25px;background-image:url('../themes/default/images/form_delete.gif');background-repeat:no-repeat;background-position:5px center;" onclick="updateAjax('form_bindcategory_list_{$smarty.foreach.category_list.iteration}','zoznam_bindcategory','goIn','delete')">
		</div>
