{strip}
	{insert name=initialize_pager_vars list=$list}
				...
				<tr>
					...
					<td width="150">&nbsp;&nbsp;
						<select name="setPerPage" onchange="pager.submit()">
							...
							<option value="null" {if $perpage eq null}selected="selected"{/if}>všetky záznamy</option>
						</select>
					</td>
					</form>
					...
					{if ($p_previousStart >= 0) AND ($perpage neq null)}
