...
<table class="tb_middle">
	<tr>
		<td colspan="3">
			<table class="tb_title">
				<tr>
					<td><img class="img_middle" src="images/news_view.png" alt="" />&nbsp;&nbsp;{insert name='tr' value='Novinky'}</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr><td colspan="3" class="td_link_v"></td></tr>
	{foreach name='article' from=$news_list item='article_id' }
	{/foreach}
	...
	<tr>
		...
		<td class="td_middle_center">
			...
			{include file="Proxia:default.pager" list=$news_list}
			<br />
		</td>
	</tr>
	<tr><td colspan="3" class="td_link_v"></td></tr>
