...
function setFrontpageVisibility(the_form,min,max,act_type,act_value,language,row){

		document.forms[the_form].elements[row].checked = true;
		document.forms[the_form].section.value="frontpage_language_visibility";
		addelement("frontpage_language",language);
		submitform(act_type,act_value)
  }
	...
	<tr>
		<td colspan="3">
			<table class="tb_title">
				<tr>
					<td><img class="img_middle" src="images/frontpage_view.png" alt="" />&nbsp;&nbsp;{insert name='tr' value='Úvodná stránka'}</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr><td colspan="3" class="td_link_v"></td></tr>
	{foreach name='article' from=$frontpage_list item='article_id'}
	{/foreach}
	{assign var='max_list' value=$smarty.foreach.article.iteration}
	<tr>
