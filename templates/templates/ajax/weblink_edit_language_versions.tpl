...
<input type="hidden" id="section" name="section" value="weblink_languages" />
...
<table class="tb_list_in_tab" align="center">
	...
	<tr>
		...
		<td><input type="checkbox" name="a_languageIsVisible{$language_id.code}" id="f_languageIsVisible{$language_id.code}" value="1" {if $weblink_detail->getLanguageIsVisible() eq 1}checked="checked"{/if} /></td>
